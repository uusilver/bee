...
/**
 * TODO The class WebSecurityConfig2 is supposed to be documented...
 *
 * @author Vani Li
 */
@Configuration
public class WebSecurityConfig2 extends WebMvcConfigurerAdapter {
    /**
     * 登录session key
     */
